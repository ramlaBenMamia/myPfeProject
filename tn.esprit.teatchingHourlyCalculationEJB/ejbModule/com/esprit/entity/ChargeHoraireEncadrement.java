...
/**
 * Entity implementation class for Entity: ChargeHoraireEncadrement
 *
 */
@Entity

public class ChargeHoraireEncadrement implements Serializable {
...
//  private List<Enseignant> enseignants;
	...
	public ChargeHoraireEncadrement() {
		super();
	}
	...
	// @OneToMany(mappedBy="chargeHoraireEncadrement")
